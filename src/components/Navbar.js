...
const Navbar = () => {
    ...
    return (
       <>
            ...
            <div className='navbar-container'>
               ...
               <Link  to='/' className='navbar-logo'>  TRVL 
   ...
   <li >
            ...
            <li className='nav-btn-li'><Link to='/sign-up'  ><button className='nav-btn-outline'>SIGN UP</button></Link></li>


          {/* <li className='nav-item'><Link to='/sign-up' className='nav-links' ><button className='btn--outline'>SIGN UP</button></Link></li>
        */}
    </ul>
